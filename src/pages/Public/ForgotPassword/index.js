...
const ForgotPassword = () => {
    const { isSucceed, message, isSent } = useSelector(state => state.authentication)
    ...
    return (
        isSucceed ? (
            <Publicformheader imageSrc={placeholder} title="Verify your Account" description="We emailed you the six digit code to example@gmail.com. Enter the code
